...
const ModalLoading = () => {
  return (
    <div
      className="flex items-center w-[300px] border-[1px] border-gray-200
    rounded-lg flex-row p-4 z-20"
      style={{ backgroundColor: "rgb(104 117 245 / var(--tw-bg-opacity))" }}
    >
      <svg
        className="w-8 h-8 mr-2 animate-spin text-gray-100
