...
const EventCard: React.FC<EventCardProps> = ({ eventData, deleteMethod }) => {
  const temporalImage: string =
    "https://images.pexels.com/photos/2570367/pexels-photo-2570367.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2";
